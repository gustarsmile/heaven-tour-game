...
**階段 1（垂直切片）**：序章 → 夜遇濟公 → 雲隙看樹苗 → 南天門 → 東華宮讀樹 → 瑤池簡易結算。一輪約 11–23 分鐘（`node scripts/estimate-length.mjs`）。完整十三站與精簡七站見設計文件 `docs/superpowers/specs/2026-08-29-heaven-tour-design.md`。
